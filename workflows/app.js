...
// Note: You will need to create this PremiumScreen.js file.
// ملاحظة: ستحتاج إلى إنشاء ملف PremiumScreen.js هذا.
             ...
             <Stack.Screen name="ForgotPassword">
              ...
              <Stack.Screen name="profile">
                 {(props) => <ProfileScreen
                                ...
                                navigateToPremium={() => props.navigation.navigate('PremiumScreen')}
              ...
              <Stack.Screen name="PremiumScreen">
                {(props) => <PremiumScreen {...props} language={appLanguage} darkMode={isAppDarkMode} />}
              </Stack.Screen>
