...
// ===================================================================
// --- 1. الثيمات والترجمات (بدون تغيير) ---
// ===================================================================
const lightTheme = {
...
// ===================================================================
// --- 2. المكونات الاحترافية الديناميكية (بدون تغيير) ---
// ===================================================================
...
// ===================================================================
// --- 3. شاشة مستوى النشاط (ActivityLevelScreen) (بدون تغيير) ---
// ===================================================================
  ...
  return (
    <SafeAreaView style={styles.safeArea(theme)}>
      ...
      <View style={styles.container}>
        {/* تم إزالة ال View الإضافي ليكون الهيكل مطابقاً للشاشة الأخرى */}
...
// ===================================================================
// --- 4. الأنماط الديناميكية (تم تطبيق التعديلات هنا) ---
// ===================================================================
const styles = {
  ...
  container: { 
    flex: 1, 
    padding: 24 // <<<< مطابق للشاشة الأخرى
  },
  ...
  cardsContainer: { 
      flex: 1, // <<<< مطابق للشاشة الأخرى (formContainer)
  ...
  footer: { 
    paddingTop: 10,
    paddingBottom: 20, // <<<<< مطابق للشاشة الأخرى
  },
